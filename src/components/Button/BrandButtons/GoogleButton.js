...
export default function GoogleButton(GoogleButtonProps) {
    let ButtonStyleConfiguration = {
        size: GoogleButtonProps.size,
    }
    return (
        <button {...GoogleButtonProps} className={`pu-button pu-button__outline ${ButtonStyleConfiguration.size}`}
            style={{
                display: 'flex',
                flexDirection: 'row',
                alignItems: 'center',
