        ...
        <div className="landing-page">
            <div className="hero-section content-center">
                ...
                <div style={{
                    ...
                    <Button value="Who's the developer tho?" style={{ backgroundColor: 'var(--primary-theme-color)' }} 
                        data-for="developer-tooltip"
                        data-tip=''
                    />
                    <ReactTooltip id="developer-tooltip">
                        <div className="developer-tooltip__header-wrapper" style={{
                            display: 'flex',
                            flexDirection: 'row',
                            alignItems: 'center',
                            gap: '6px'
                        }}>
                            <img src="https://www.github.com/yashsehgal.png" alt="yashsehgal" className="developer-profile-from-github"
                                style={{ 
                                    width: '36px', 
                                    height: 'auto', 
                                    borderRadius: '50%', 
            ...
            <div className="utility-docs-section content-center" style={{ marginTop: '6em' }}>
                {/* Header component usage */}
                <div className="header-component-usage-section">
                    <h3 className="component-title">Header component</h3>
                    <p className="component-description">
                        Header component is one of the coolest feature I have made. The logic and implementation is inpired from Docusaurus' header and UI is from Figma.
                    </p>
                    <h4 className="component-sub-title">Implementation</h4>
                    <div className="header-component-container" style={{ width: '90%', marginRight: 'auto', marginLeft: 'auto', marginBottom: '2em' }}>
